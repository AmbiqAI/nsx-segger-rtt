...
- A subset of upstream `RTT/` and `Config/`, copied unchanged. The upstream
  `Config/SEGGER_RTT_Conf.h` lives under `Config/upstream/`; the
  `Config/SEGGER_RTT_Conf.h` beside it is module-owned.
...
d02ef83f826dd29cddb466adca6c75dbdd71128f18bc6bef1113ca0127944d6f  Config/upstream/SEGGER_RTT_Conf.h
